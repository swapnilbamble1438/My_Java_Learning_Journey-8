...
//================ create user ======================================================================================================================
	...
	public User createUser(User user, Set<User_role> user_roles)throws Exception {
	 ...
	 {
		 System.out.println("\n====================================================================\n"
		           + "         Message: User already present with same username try using different username...  \n"
		           + "====================================================================");
		
		 throw new Exception("\n====================================================================\n"
		 		           + "        Exception: User already present with same username try using different username... \n"
		 		           + "====================================================================");
...
//================ get user by uid ======================================================================================================================
	...
	public User getUserByUid(int uid) throws Exception {
		...
		else
		{
			 ...
			 throw new Exception("\n====================================================================\n"
	 		           + "         Exception: There is no User with uid: "+uid+" exists... \" \n"
	 		           + "====================================================================");
...
//================ get user by username ======================================================================================================================
	...
	public User getUser(String username) throws Exception {
		...
		if(this.userRepo.findByUsername(username) == null)
		{
			 ...
			 throw new Exception("\n====================================================================\n"
	 		           + "         Exception: There is no User with username: "+username+" exists... \" \n"
	 		           + "====================================================================");
		}
