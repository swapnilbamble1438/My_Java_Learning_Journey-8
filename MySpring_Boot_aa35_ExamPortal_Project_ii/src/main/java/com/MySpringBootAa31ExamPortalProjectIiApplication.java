...
public class MySpringBootAa31ExamPortalProjectIiApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(MySpringBootAa31ExamPortalProjectIiApplication.class, args);
	}
